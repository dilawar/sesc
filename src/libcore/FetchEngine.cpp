...
{
  int32_t n2Fetched=fetchMax > 0 ? fetchMax : FetchWidth;     //i.e n2Fetched=4(usually), means a bucket contain 4 dinsts
  ...
  do {
    ...
    n2Fetched--;     //number of instructions to fetch and push in the bucket
