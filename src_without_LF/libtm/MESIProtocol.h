...
public:  
  ...
  #ifdef TLS
	void doSendReadPropagate(MemRequest *mreq);
	void doSendWritePropagate(MemRequest *mreq);
	void invalidateHandlerTLS(SMPMemRequest *sreq);
	  void dummy1(MemRequest* mreq){};
   typedef CallbackMember1<MESIProtocol,MemRequest *,
                   &MESIProtocol::dummy1> dummy1CB;
  #endif
};
